            ...
            <div id="toast-message-cta" class="p-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:bg-gray-800 dark:text-gray-400" role="alert">
                <div class="flex">
                    ...
                    <div class="ml-3 text-sm font-normal">
                        <span class="mb-1 text-sm font-semibold text-gray-900 dark:text-white">{user?.displayname}</span>
                        <div class="mb-2 text-sm font-normal">Hey {user?.displayname} you have new message</div>
